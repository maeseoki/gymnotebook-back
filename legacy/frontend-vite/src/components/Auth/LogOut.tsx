...
export default function LogOut() {
  ...
  return (
    <>
      <Button rightIcon={<IoLogOutOutline />} variant="outline" colorScheme="red" onClick={logout}>
        Salir
      </Button>
      <AlertDialog isOpen={isLogoutOpen} leastDestructiveRef={logoutRef} onClose={onLogoutClose}>
        <AlertDialogOverlay>
          <AlertDialogContent>
