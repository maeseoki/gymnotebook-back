...
export default function NoWorkout() {
  ...
  return (
    <Flex gap={4} direction="column">
      ...
      <Button variant="secondaryGradient" size="lg" onClick={startWorkout}>
        ¡Entrenar!
      </Button>
      <Heading as="h2" size="lg" mt={12} textAlign="center">
        Ejercios y entrenos
      </Heading>
      <Flex gap={4} mt={4} justifyContent="space-evenly">
        <Button variant="primaryGradient" as={RouterLink} to="/exercises">
          Mis Ejercicios
        </Button>
        <Button variant="primaryGradient" as={RouterLink} to="/me">
          Mis Entrenamientos
        </Button>
      </Flex>
    </Flex>
