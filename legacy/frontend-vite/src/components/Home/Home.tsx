...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <AlertTitle mt={4} mb={1} me={0} fontSize="lg">
        Bienvenido {user?.name ?? 'de nuevo'}!
      </AlertTitle>
      <AlertDescription maxWidth="sm">
        Recuerda que aún estamos en fase Beta. Puede que haya algo que no funcione. ¡No te
        preocupes! Estamos trabajando en ello 👷
      </AlertDescription>
      <HStack spacing={2} mt={4}>
        <Button as={RouterLink} to="/workout">
          ¡Entrenar!
        </Button>
      </HStack>
    </Alert>
